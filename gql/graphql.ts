...
export type MutationImageRestoreArgs = {
  input: ImageRestoreInput;
};
...
export type ImageByIdQuery = {
  ...
  node?:
    | {
        ...
        originalImage?: { __typename?: "Image"; id: string } | null;
      }
    | { __typename?: "Me" }
    | { __typename?: "Video" }
    | null;
...
export type useUsageQueryVariables = Exact<{ [key: string]: never }>;

export type useUsageQuery = {
  __typename?: "Query";
  me?: {
    __typename?: "Me";
    id: string;
    ...
    planFeaturesUsage?: {
      ...
      startDate: any;
      endDate: any;
      imageCreation: { __typename?: "UsageLimit"; limit: number; used: number };
      editImage: { __typename?: "UsageLimit"; limit: number; used: number };
      imageRestoration: {
        __typename?: "UsageLimit";
        limit: number;
        used: number;
      };
      videoCreation: { __typename?: "UsageLimit"; limit: number; used: number };
    } | null;
  } | null;
};
...
export type ConfirmUserEmailMutation = {
  __typename?: "Mutation";
  confirmUserEmail?: { __typename?: "Me"; id: string } | null;
};
...
export type OnboardingQuery = {
  ...
  me?: {
    ...
    onboarding: {
      __typename?: "Onboarding";
      hasCreatedFirstImage: boolean;
      hasCreatedFirstVideo: boolean;
      hasCreatedFirstImageEdit: boolean;
    };
  } | null;
};
...
export type ImageCreationMutation = {
  __typename?: "Mutation";
  imageCreation: {
    __typename?: "Image";
    id: string;
...
export type ManageSubscriptionQuery = {
  __typename?: "Query";
  me?: { __typename?: "Me"; id: string; customerPortalUrl: string } | null;
};
...
export type SignInMutation = {
  __typename?: "Mutation";
  signIn: { __typename?: "Me"; id: string; email: string; fullName: string };
};
...
export type ImageRestoreMutationVariables = Exact<{
  input: ImageRestoreInput;
}>;

export type ImageRestoreMutation = {
  __typename?: "Mutation";
  imageRestore: {
    __typename?: "Image";
    id: string;
...
export type UpdateUserPasswordMutation = {
  __typename?: "Mutation";
  updateUserPassword: { __typename?: "Me"; id: string; email: string };
};
...
export type VideoCreationMutation = {
  __typename?: "Mutation";
  videoCreation: { __typename?: "Video"; id: string; status: GenAiStatusEnum };
};

export const ImageByIdDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "ImageById" },
      variableDefinitions: [
        {
...
} as unknown as DocumentNode<ImageByIdQuery, ImageByIdQueryVariables>;
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "isSocialLogin" },
                },
                {
                  kind: "Field",
                ...
                { kind: "Field", name: { kind: "Name", value: "email" } },
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "imageCreation" },
                        selectionSet: {
                          kind: "SelectionSet",
                          selections: [
                            {
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "imageRestoration" },
                        selectionSet: {
                          kind: "SelectionSet",
                          selections: [
                            {
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "videoCreation" },
                        selectionSet: {
                          kind: "SelectionSet",
                          selections: [
                            {
...
} as unknown as DocumentNode<useUsageQuery, useUsageQueryVariables>;
      ...
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "ConfirmUserEmailInput" },
            },
          },
        },
      ],
                ...
                { kind: "Field", name: { kind: "Name", value: "id" } },
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "hasCreatedFirstImage" },
                      },
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "hasCreatedFirstVideo" },
                      },
                      {
                        kind: "Field",
                        name: {
                          kind: "Name",
                          value: "hasCreatedFirstImageEdit",
                        },
                      },
                    ],
                  },
      ...
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "AddFeedbackInput" },
            },
          },
        },
      ],
...
>;
export const ImageGalleryDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
          ...
          type: {
            ...
            type: {
              ...
              type: {
                ...
                type: {
                  kind: "NamedType",
                  name: { kind: "Name", value: "ImageTypeOptionsEnum" },
                },
              },
            },
          },
...
} as unknown as DocumentNode<ImageGalleryQuery, ImageGalleryQueryVariables>;
export const VideoGalleryDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "VideoGallery" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
...
} as unknown as DocumentNode<VideoGalleryQuery, VideoGalleryQueryVariables>;
export const ImageCreationDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      ...
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "ImageCreationInput" },
            },
          },
        },
      ],
  ...
  ImageCreationMutation,
  ImageCreationMutationVariables
>;
export const ImageEditDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "ImageEdit" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "ImageEditInput" },
            },
          },
        },
      ],
...
} as unknown as DocumentNode<ImageEditMutation, ImageEditMutationVariables>;
...
>;
export const ImageRestoreDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "ImageRestore" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "ImageRestoreInput" },
            },
          },
        },
      ],
  ...
  ImageRestoreMutation,
  ImageRestoreMutationVariables
>;
      ...
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "SignUpUserInput" },
            },
          },
        },
      ],
...
export const VideoCreationDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      ...
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "VideoCreationInput" },
            },
          },
        },
      ],
  ...
  VideoCreationMutation,
  VideoCreationMutationVariables
>;
